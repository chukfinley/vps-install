...
sudo apt install zsh zsh-syntax-highlighting zsh-autosuggestions tree htop ncdu yt-dlp btop thefuck neofetch python3-pip git cmake make gcc build-essential docker docker.io docker-compose tmux net-tools curl wget -y
